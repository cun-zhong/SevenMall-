	...
	export default {
		...
		methods: {
			...
			tuichu() {
				...
				console.log("缓存区")
				console.log(this.$store.state.user.user.user.id)
				// let abc = window.sessionStorage.getItem('user');
				
				// let abcde = JSON.parse(abc);
				// console.log(abcde);
				// console.log(abcde.user);
				// console.log(abcde.user.id);
